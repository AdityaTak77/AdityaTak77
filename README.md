...
<img src="https://capsule-render.vercel.app/api?type=waving&color=gradient&customColorList=0,2,2,3,3&height=200&section=header&text=Aditya%20Tak&fontSize=80&fontAlignY=35&animation=twinkling&fontColor=fff" width="100%"/>
...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/Location-Earth--616-00D9FF?style=for-the-badge&logo=google-earth&logoColor=white" />
...
class Developer:
    def __init__(self):
        ...
        self.current_work = {
            "ai_tools": "Building AI-powered desktop applications",
            "gen_ai": "Exploring LLMs, RAG systems, and LangChain",
            "ml_solutions": "Creating practical machine learning tools",
            "game_dev": "Crafting games with unique mechanics"
        }
        ...
        self.life_motto = "Build. Learn. Innovate. Repeat. 🔄"
...
![Prompt Engineering](https://img.shields.io/badge/Prompt_Engineering-00D9FF?style=for-the-badge&logo=chatbot&logoColor=white)
...
+ 🤖 Create an AI agent framework from scratch

Game Development
+ 🎮 Release 2 complete games with unique mechanics
+ 🕹️ Experiment with procedural generation
...
<a href="mailto:karanbhatt1856@gmail.com">
...
![](https://komarev.com/ghpvc/?username=Cykikz&color=00D9FF&style=for-the-badge&label=VISITORS)
...
this read me is of my friends and i want to use it and just update it with my info 
